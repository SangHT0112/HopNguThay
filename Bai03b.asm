...
main proc                   ; Bắt đầu định nghĩa hàm main.
  push n                    ; Đẩy giá trị của biến n vào stack để truyền vào hàm TinhSn3b.
  call TinhSn3b             ; Gọi hàm TinhSn3b để tính tổng và trả về kết quả trong thanh ghi eax.
...
TinhSn3b proc               ; Bắt đầu định nghĩa hàm TinhSn3b.
...
for1:                       ; Nhãn cho vòng lặp.
  ...
  shl eax, 1                ; Nhân eax với 2 để có giá trị của (2n-1).
  inc eax                   ; Tăng eax lên một đơn vị để có giá trị của (2n-1)+1 = 2n.
  imul eax, eax             ; Nhân kết quả với (2n+1) để có phép nhân (2n-1)*(2n+1).
...
TinhSn3b endp               ; Kết thúc định nghĩa hàm TinhSn3b.
