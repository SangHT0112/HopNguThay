...
main proc                   ; Bắt đầu định nghĩa hàm main.
  push n                    ; Đẩy giá trị của biến n vào stack để truyền vào hàm TinhSn1a.
  call TinhSn1a             ; Gọi hàm TinhSn1a để tính tổng và trả về kết quả trong thanh ghi eax.
...
TinhSn1a proc               ; Bắt đầu định nghĩa hàm TinhSn1a.
  ...
  xor eax, eax              ; Xoá giá trị của eax, sử dụng eax để tính tổng các số từ 1 đến n.
...
TinhSn1a endp               ; Kết thúc định nghĩa hàm TinhSn1a.
