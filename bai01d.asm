...
main proc                   ; Bắt đầu định nghĩa hàm main.
  push n                    ; Đẩy giá trị của biến n vào stack để truyền vào hàm TinhSn1d.
  call TinhSn1d             ; Gọi hàm TinhSn1d để tính tổng và trả về kết quả trong thanh ghi eax.
...
TinhSn1d proc               ; Bắt đầu định nghĩa hàm TinhSn1d.
...
for1:                       ; Nhãn cho vòng lặp.
  ...
  add eax, ebx              ; Cộng giá trị của ebx vào tổng eax.
