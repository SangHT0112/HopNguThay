...
main proc                   ; Bắt đầu định nghĩa hàm main.
  push n                    ; Đẩy giá trị của biến n vào stack để truyền vào hàm TinhSn2b.
  call TinhSn2b             ; Gọi hàm TinhSn2b để tính tổng và trả về kết quả trong thanh ghi eax.
...
TinhSn2b proc               ; Bắt đầu định nghĩa hàm TinhSn2b.
...
for1:                       ; Nhãn cho vòng lặp.
  ...
  add eax, 1                ; Thêm 1 vào kết quả để có (2k + 1)^2.
...
TinhSn2b endp               ; Kết thúc định nghĩa hàm TinhSn2b.
